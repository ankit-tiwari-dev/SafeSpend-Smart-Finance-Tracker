...
const SideMenu = ({ activeMenu, closeSideMenu }) => {
  ...
  return (
    <>
      <aside className="h-full flex flex-col bg-[var(--color-sidebar)] p-8 overflow-y-auto scrollbar-hide hover:scrollbar-default transition-all">
        <style>{`
            ...
            <div className="relative mb-4">
              ...
              {user?.profileImageUrl ? (
                <img
                  ...
                  alt="Profile"
                  className="w-20 h-20 rounded-full relative z-10 border-2 border-white/10 ring-4 ring-black"
                />
              ) : (
        ...
        <nav className="flex-1 space-y-3">
          <p className="text-[10px] font-black uppercase tracking-[0.3em] text-[var(--color-text)] opacity-20 mb-6 ml-4">
            Command Center
          </p>
              ...
              >
                ...
                <item.icon
                  className={`text-xl transition-all duration-500 ${
                    isActive
                      ? "scale-110 drop-shadow-[0_0_8px_rgba(var(--color-primary-rgb),0.5)]"
