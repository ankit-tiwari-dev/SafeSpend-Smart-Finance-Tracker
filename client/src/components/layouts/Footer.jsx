            ...
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start gap-16 relative z-10">
                <div className="space-y-8 max-w-sm">
                    ...
                    <div className="flex gap-4">
                        {[LuTwitter, LuLinkedin, LuInstagram, LuFacebook].map((Icon, i) => (
                            <a key={i} href="#" className="w-10 h-10 rounded-xl bg-[var(--color-divider)] border border-[var(--color-border)] flex items-center justify-center text-[var(--color-text-muted)] hover:text-primary hover:border-primary/20 hover:bg-primary/5 transition-all duration-300">
                                <Icon size={18} />
                            </a>
                        ))}
                    </div>
